...
class VectorStore:
    ...
    def get_course_outline(self, course_name: str) -> Optional[Dict[str, Any]]:
        """Get the full outline of a course by name (supports fuzzy matching).

        Returns dict with title, course_link, and lessons list, or None if no match.
        """
        import json
            ...
            if results and 'metadatas' in results and results['metadatas']:
                ...
                if lessons_json:
                    lessons = [
                        ...
                        for l in json.loads(lessons_json)
                    ]
                return {
